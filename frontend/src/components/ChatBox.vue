        ...
        return {
            ...
            */
            ...
            greetings: [
                ...
                `${this.$store.state.user.username}....Everyone asks the chat bot how to set a base case for recursive functions but no one asks chat bot how chat bot is doing +_+`,
                `Is that an RTX 3090 in your pocket ${this.$store.state.user.username} or are you happy to see me? +_+`,
