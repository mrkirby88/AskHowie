<template>
    <div class="main">
      <navigation />
        <div class="article">
            <h1 class="header"> About Chatbot</h1>
                <p class="paragraph"> Welcome to Chatbot, the revolutionary way to fetch information from the internet! Who needs google when you have Chatbot at your disposal?
